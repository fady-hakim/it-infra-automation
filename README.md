...
The `daily-security-audit.yml` workflow runs every day automatically on GitHub Actions — no manual steps required. Audit results are published directly to the live dashboard.
